...
@section('content')
    ...
    <section class="=container my-5 ">
        ...
        <div class="  my-5 has-text-right columns is-fullheight">
            ...
            <aside class=" menu column is-2 is-narrow-mobile is-fullheight section ">
                <form method="POST" action="{{ route('filter') }}">
                    ...
                    <button class="btn bg-danger" type="submit" > بحث</button>
                ...
                <div class="row">
                    ...
                    @foreach ($product as $products)
                        <div class="col-lg-2 col-md-3 col-sm-3 d-flex ">
                            <div class="card w-100  my-3 shadow-2-strong ">
                                ...
                                @else
                                    <img src="{{ url('/images/pngtree-pure-white-minimalist-background-wallpaper-image_396581.jpg') }}"
                                        style="height: 150px;" alt="Example Image">
                                @endif
